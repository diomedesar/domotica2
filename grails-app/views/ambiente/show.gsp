...
<html>
    ...
    <body>
        ...
        <div id="show-ambiente" class="content scaffold-show" role="main">
            ...
            <f:display bean="ambiente" />
            <g:form resource="${this.ambiente}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ambiente}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

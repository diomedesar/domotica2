...
<html>
    ...
    <body>
        ...
        <div id="show-salida" class="content scaffold-show" role="main">
            ...
            <f:display bean="salida" />
            <g:form resource="${this.salida}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.salida}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

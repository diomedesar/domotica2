...
<html>
    ...
    <body>
        ...
        <div id="show-entrada" class="content scaffold-show" role="main">
            ...
            <f:display bean="entrada" />
            <g:form resource="${this.entrada}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.entrada}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

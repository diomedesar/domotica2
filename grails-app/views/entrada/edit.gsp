...
<html>
    ...
    <body>
        ...
        <div id="edit-entrada" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.entrada}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.entrada}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.entrada}" method="PUT">
                <g:hiddenField name="version" value="${this.entrada?.version}" />
                <fieldset class="form">
                    <f:all bean="entrada"/>
                </fieldset>
